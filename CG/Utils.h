...
void renderScene(const Shader& shader)
{
    ...
    shader.setMat4("model", model);
    shader.setVec3("objectColor", glm::vec3(0.2f,0.4f,0.2f));
    renderCube();
    model = glm::mat4(1.0f);
    model = glm::translate(model, glm::vec3(2.0f, 0.0f, 1.0));
    model = glm::scale(model, glm::vec3(0.5f));
    shader.setMat4("model", model);
    shader.setVec3("objectColor", glm::vec3(0.4f, 0.3f, 0.2f));
    renderCube();
    model = glm::mat4(1.0f);
    ...
    shader.setMat4("model", model);
    shader.setVec3("objectColor", glm::vec3(0.5f, 0.2f, 0.1f));
    renderCube();
}
