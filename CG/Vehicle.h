...
public:
	...
	void InitVehicle()
	{
		...
		btVector3 connectionPointCS[4] = { btVector3(0.8f, wheelHeight, -1.5f),btVector3(-0.8f, wheelHeight, -1.5f), btVector3(0.8f, wheelHeight,1.5f), btVector3(-0.8f, wheelHeight, 1.5f) };	//轮胎位置
		for (int i = 0; i < 4; i++)
		{
